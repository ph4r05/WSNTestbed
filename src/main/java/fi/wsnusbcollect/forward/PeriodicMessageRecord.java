 ...
 * @author ph4r05
 */
public class PeriodicMessageRecord implements DataCSVWritable {
    public int cycle;
    public int nodeId;
    public double mean;
    ...
    public PeriodicMessageRecord() {
    }

    public PeriodicMessageRecord(int cycle, int nodeId, double mean, double stddev, int counter, int succCounter) {
        this.cycle = cycle;
        this.nodeId = nodeId;
        this.mean = mean;
        this.stddev = stddev;
    ...
    public void writeCSVdata(CsvWriter csvOutput) throws IOException {
        ...
        csvOutput.write(String.valueOf(this.mean));
    ...
    public String getCSVname() {
        return "PeriodicMessage_" + expStart;
    }
