 ...
 */
@Repository
public class ExperimentParametersImpl implements ExperimentParameters {
    private static final Logger log = LoggerFactory.getLogger(ExperimentParametersImpl.class);
    ...
    public ExperimentParametersImpl() {
    }
